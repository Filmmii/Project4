...
<head>
  ...
  <title>
    Sign In | Project Management System
  </title>
  <!-- Fonts and icons -->
      ...
      <div class="page-header min-vh-100">
        <div class="container">
          ...
          background-size: cover;">
                ...
                <h4 class="mt-5 text-white font-weight-bolder position-relative">Project Management System</h4>
                <p class="text-white position-relative">Empowering Your Team to Plan, Track, and Achieve Goals – All in One Place, Every Step of the Way.</p>
              </div>
            </div>
          </div>
        </div>
